...
setup(
    ...
    author='Konstantin Baierer, Jan Kamlah, Kay-Michael Würzner, Robert Sachunsky',
    author_email='unixprog@gmail.com, jan.kamlah@gmail.com, wuerzner@gmail.com, sachunsky@informatik.uni-leipzig.de',
    ...
    entry_points={
        'console_scripts': [
            ...
            'ocrd-segment-replace-lines=ocrd_segment.cli:ocrd_segment_replace_lines',
